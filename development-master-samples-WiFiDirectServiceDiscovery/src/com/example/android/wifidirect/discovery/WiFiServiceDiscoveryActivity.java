...
public class WiFiServiceDiscoveryActivity extends Activity implements
	...
	private Queue<String> alertQueue = new LinkedList<String>();
	
	//For now, just send a message of queue size 2;
    public static final String TAG = "EMERGENCY_SIGNAL_SYSTEM";

    // TXT RECORD properties
    public static final String TXTRECORD_PROP_AVAILABLE = "available";
    public static final String SERVICE_INSTANCE = "_EMERGENCY_SIGNAL_SYSTEM";
    ...
    private String transferredAlert;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //for now, just set up the first two messages of the queueueueue;
        this.alertQueue.add("Tornado watch. Please stay indoors");
        this.alertQueue.add("TORNADO WARNING. DO NOT GO OUTSIDE. SEEK SHELTER IMMEDIATELY");
    ...
    private void discoverService() {
    	...
    	final WiFiServiceDiscoveryActivity thisRef = this;
...
//                                adapter.add(service);
//                                adapter.getItem(adapter.getPosition(service));
//                                adapter.notifyDataSetChanged();
                                
                                thisRef.connectP2p(service);
                                //try to click button here
    ...
    public boolean handleMessage(Message msg) {
        switch (msg.what) {
            case MESSAGE_READ:
                ...
                String alertMsg = "";
                /*for (String s : this.alertQueue) {
                	alertMsg += s + "\n";
                }*/
                (chatFragment).pushMessage("Incoming: " + readMessage);
